package com.pabula.common.logger;
...
//    }
    ...
    private void logChunk(int logType, String tag, String chunk) {
        ...
        String time = DateUtil.format(DateUtil.getCurrTime(), "yyyy-MM-dd HH:mm:ss");

        switch (logType) {
            case TYPE_E:
                System.err.println(time +" | " + finalTag +" | "+chunk);
                break;
//            case Log.INFO:
...
//                break;
            case TYPE_D:
                System.out.println(time +" | " + finalTag +" | " + chunk);
                break;
            default:
